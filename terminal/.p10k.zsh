# Generated by Powerlevel10k configuration wizard on 2023-09-26 at 15:33 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    status                  # ✓/✗ Éxito o fallo del comando
    command_execution_time  # Tiempo de ejecución
    
    # Tus lenguajes
    java_version           # ☕ Java 
    dotnet_version         # 🔷 C# / .NET
    node_version           # 📦 Node.js
    package                # 📄 package.json info
    virtualenv             # 🐍 Python virtual env
    
    # Docker/containers
    kubecontext            # ⚙️ Kubernetes/Docker
